...
public class ApiErrorHandler {
  ...
  ResponseEntity<Map<String, Object>> business(CommerceException e) {
    return response(e.getStatus(), e.getMessage(), null);
  }
  ...
  ResponseEntity<Map<String, Object>> validation(MethodArgumentNotValidException e) {
    Map<String, String> fields =
        e.getBindingResult().getFieldErrors().stream().collect(Collectors.toMap(
            x -> x.getField(), x -> x.getDefaultMessage(), (a, b) -> a, LinkedHashMap::new));
  ...
  private ResponseEntity<Map<String, Object>> response(HttpStatus s, String m, Object d) {
