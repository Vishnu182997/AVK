...
public interface AppointmentRepository extends JpaRepository<Appointment, Long> {
  ...
  Optional<com.example.appointment.staff.StaffProfile> lockStaff(@Param("id") Long id);
  List<Appointment> findByAppointmentDateBetween(LocalDate a, LocalDate b);
  List<Appointment> findByStatusAndAppointmentDateBetween(
      AppointmentStatus s, LocalDate a, LocalDate b);
}
