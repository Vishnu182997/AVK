...
public class Game {
  ...
  public Game(Color humanColor) {
    ...
    this.computerColor = humanColor.opposite();
  ...
  public Move playComputerMove() {
    ...
    if (board.getSideToMove() != computerColor) {
      return null;
    }

    Move move = engine.getBestMove(board, computerColor);
  ...
  private void checkGameEnd() {
    ...
    boolean hasMoves = generator.hasLegalMoves(board, board.getSideToMove());
