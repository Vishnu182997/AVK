...
public class MoveValidator {
  ...
  private boolean sameMove(Move a, Move b) {
    return a.getFromRow() == b.getFromRow() && a.getFromCol() == b.getFromCol()
        && a.getToRow() == b.getToRow() && a.getToCol() == b.getToCol();
  }

  /**
   * Checks whether the current player is in check.
   */
  public boolean isCheck(ChessBoard board, Color color) {
