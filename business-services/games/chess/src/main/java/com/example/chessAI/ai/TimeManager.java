...
public class TimeManager {
  ...
  public long getRemainingTime() {
    long remaining = stopTime - System.currentTimeMillis();
   ...
   * 5 minutes / 40 moves
   */
  public static long calculateMoveTime(long remainingTime, int movesRemaining) {
    if (movesRemaining <= 0) {
      return remainingTime / 10;
    }

    long time = remainingTime / movesRemaining;

    /*
     * Keep some safety margin.
     */
    return (long) (time * 0.85);
  }
}