...
public class ChessGUI extends JFrame {
  ...
  private JPanel createControlsPanel() {
    ...
    difficultySelector.addActionListener(
        e -> boardPanel.setAiDifficulty((AiDifficulty) difficultySelector.getSelectedItem()));
    ...
    humanColorSelector.addActionListener(
        e -> boardPanel.setHumanColor((Color) humanColorSelector.getSelectedItem()));
  ...
  private void updateModeControls() {
    ...
    sideLabel.setText(aiMode ? "You: " + boardPanel.getHumanColor()
                + "  Computer: " + boardPanel.getHumanColor().opposite()
