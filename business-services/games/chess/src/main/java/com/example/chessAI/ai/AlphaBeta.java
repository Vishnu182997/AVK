...
public class AlphaBeta {
   ...
   */
  public int search(ChessBoard board, int depth, int alpha, int beta, boolean maximizingPlayer) {
    if (depth == 0) {
    ...
    if (maximizingPlayer) {
      ...
      for (Move move : moves) {
        ...
        int score = search(board, depth - 1, alpha, beta, false);
      ...
      for (Move move : moves) {
        ...
        int score = search(board, depth - 1, alpha, beta, true);
