...
public class OpeningBook {
  ...
  private void initializeBook() {
     ...
     * e2-e4
     */
    moves.add(new Move(6, 4, 4, 4));

    /*
     * d2-d4
     */
    moves.add(new Move(6, 3, 4, 3));

    /*
     * c2-c4
     */
    moves.add(new Move(6, 2, 4, 2));

    book.put(startPosition, moves);
  }
   ...
   */
  public void addOpening(String fen, Move move) {
    List<Move> moves = book.get(fen);
