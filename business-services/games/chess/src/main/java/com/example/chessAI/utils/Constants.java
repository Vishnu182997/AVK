...
public final class Constants {
  ...
  public static final String WHITE_SQUARE_COLOR = "#F0D9B5";

  public static final String BLACK_SQUARE_COLOR = "#B58863";
  ...
  public static final String PIECE_IMAGE_PATH = "/piece_images/";

  public static final String SOUND_PATH = "/sounds/";

  public static final String OPENING_BOOK = "/opening_book.bin";
  ...
  public static final long DEFAULT_THINK_TIME = 5000; // milliseconds

  public static final int CHECKMATE_SCORE = 200000;
