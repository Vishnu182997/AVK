...
public class SquarePanel extends JPanel {
  ...
  private void paintLastMoveHint(Graphics g) {
    ...
    java.awt.Color fill =
        lastMoveTo ? new java.awt.Color(255, 214, 10, 115) : new java.awt.Color(255, 238, 88, 75);
    g2.setColor(fill);
    g2.fillRect(0, 0, getWidth(), getHeight());
    g2.setColor(
        lastMoveTo ? new java.awt.Color(255, 143, 0, 210) : new java.awt.Color(255, 193, 7, 180));
