...
class TicketServiceImplTest {
  ...
  void rejectsInvalidInput() {
    ...
    request.setTitle("x");
    assertEquals(400,
        assertThrows(TicketException.class, () -> service.create(request, owner)).getStatusCode());
  }
  ...
  void retrievesOwnedTicketAndRejectsAnotherUser() {
    ...
    assertEquals(403,
        assertThrows(
            TicketException.class, () -> service.findById(1L, new TicketActor("202", false)))
            .getStatusCode());
  }
  ...
  void returnsNotFound() {
    ...
    assertEquals(404,
        assertThrows(TicketException.class, () -> service.findById(99L, owner)).getStatusCode());
  }
  ...
  void enforcesWorkflowAndStatusPermission() {
    ...
    assertEquals(403,
        assertThrows(
            TicketException.class, () -> service.updateStatus(1L, TicketStatus.IN_PROGRESS, owner))
            .getStatusCode());
    assertEquals(400,
        assertThrows(
            TicketException.class, () -> service.updateStatus(1L, TicketStatus.RESOLVED, manager))
            .getStatusCode());
  }
