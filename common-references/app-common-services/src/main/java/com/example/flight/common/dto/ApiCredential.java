...
public class ApiCredential implements Serializable {
	...
	private Integer showCorporateFaresForGalIndigo;

	private boolean calendarSearchAvailable;
	...
	@JsonProperty("disableChangeRBDOption")
	private int disableChangeRBDOption = 2;
	private boolean isHoldBook;
}
