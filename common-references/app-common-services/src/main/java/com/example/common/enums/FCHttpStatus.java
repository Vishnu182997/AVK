...
public enum FCHttpStatus {
	...
	SESSION_EXPIRED(4,"SESSION_EXPIRED"),FAILED(5,"FAILED"),PASSWORD_POLICY_ERROR_CODE(3,"PASSWORD_POLICY_ERROR_CODE"),UN_AUTHORIZED(6,"UN_AUTHORIZED"),WARNING_MESSAGE(7,"WARNING_MESSAGE"),
	BOOKING_VALIDATION_ERROR_CODE(8,"BOOKING_VALIDATION_ERROR_CODE"),
	BOOKING_COMPLETED(9,"BOOKING_COMPLETED"),
	DUPLICATE_TRIP_RESTRICTION_ERROR_CODE(10,"DUPLICATE_TRIP_RESTRICTION_ERROR_CODE"),
	BUDGET_CHECK_ERROR_CODE(11,"BUDGET_CHECK_ERROR_CODE"),BUDGET_RESTRICTION_ERROR_CODE(12,"BUDGET_RESTRICTION_ERROR_CODE"),TRIP_DATES_RESTRICTION_ERROR_CODE(13,"TRIP_DATES_RESTRICTION_ERROR_CODE"),SHOW_POLICY_MESSAGES(14,"SHOW_POLICY_MESSAGES"),
	FEEDBACK_MANDATORY_ERROR_CODE(15,"FEEDBACK_MANDATORY_ERROR_CODE");

	private int code;
	private String desc;

	FCHttpStatus(int code, String desc) {
		this.code = code;
		this.desc = desc;
	}
	...
	public static FCHttpStatus getFCHttpStatusByCode(int statusCode) {
		for (FCHttpStatus status : values()) {
