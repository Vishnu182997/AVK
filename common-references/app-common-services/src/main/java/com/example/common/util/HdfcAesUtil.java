...
public class HdfcAesUtil {
	...
	public static void main1(String args[]){
		...
		if(err==null) {
			try {
				HdfcAesUtil encrypter = new HdfcAesUtil(key);
	...
	public static void main(String[] args) {
		HdfcAesUtil aes = new HdfcAesUtil("8E60F88CDB7BECBDA1D41800E9196AFD");
