...
public class ThirdPartyLogUtils {
    ...
    private static void customRequestLogger(ThirdPartyLoggerDTO loggerMessage) {
        logger.info("Input Request: " + AvkCommonUtil.getResponseBody(loggerMessage));
    }

    private static void customResponseLogger(ThirdPartyLoggerDTO loggerMessage) {
        logger.info("OutPut Response: " + AvkCommonUtil.getResponseBody(loggerMessage));
    }
    ...
    private static void exceptionLogger(ThirdPartyLoggerDTO loggerMessage) {
        ...
        LogUtils.printThirdPartyDebuggerLogs(null, AvkCommonUtil.getResponseBody(loggerMessage), "ERROR", null);
    }
    ...
    private static boolean thirdPartyReqRspLogger(ThirdPartyLoggerDTO loggerMessage) {
    	if ("true".equalsIgnoreCase(System.getenv("PRINT_LOG")) || "true".equalsIgnoreCase(System.getenv("PRINT_SUPPLIER_REQ_RES"))) {
    		...
    		LogUtils.printThirdPartyDebuggerLogs(null, AvkCommonUtil.getResponseBody(loggerMessage), null, null);
    		return true;
    ...
    public static void printLog(Object value) {
    	if ("true".equalsIgnoreCase(System.getenv("PRINT_LOG"))) {
	        if (value instanceof String) {
	            ...
	            logger.info(AvkCommonUtil.getResponseBody(value));
	        }
    	}
    }
    ...
    private static void sendLogToSQS(ThirdPartyLoggerDTO thirdPartyLoggerDTO, boolean printLog) {
        try {
            ...
            if (AvkCommonUtil.isStringNotEmpty(third_party_loggers_sqs_queue_name) && AvkCommonUtil.isStringNotEmpty(sqs_log_s3_bucket_name)) {
                /*
                ...
                SendMessageRequest send_msg_request = new SendMessageRequest()
                        ...
                        .withMessageBody(AvkCommonUtil.getResponseBody(thirdPartyLoggerDTO));
        	...
        	if(!printLog) {
        		logger.info("Third Party Api Logger: " + AvkCommonUtil.getResponseBody(thirdPartyLoggerDTO));
        	}
            exceptionLogger(e);
        }
    }
